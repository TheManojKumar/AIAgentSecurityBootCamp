...
│   └── 02_subtle_embed.txt
├── defenses/
│   ├── allowlist.py         # Layer 1 — least agency
│   ├── input_separation.py  # Layer 2 — instruction/data separation
│   ├── tool_validation.py   # Layer 3 — argument validation
│   └── guardrail.py         # Layer 4 — input guardrail
├── workspace/
